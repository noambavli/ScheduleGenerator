### זה צריך עוד טסטים ובדיקות על קלטים, הרעיון זה מימוש האלגוריתם כדי להגיע לתוצאה רצוייה, הנראות וחווית המשתמש יכלה להיות הרבה יותר טובה אבל שוב זה לא קושי להוסיף לקוח (שפשוט יקבל וישמור מידע ויציג למשתמש) ועבור הפרוייקט של ה10 יחל אכתוב את זה גם בג'אווה עם UI מהמם.
